...
## Xu Xinyi, Minchen Cai, Haona Yang, Mingkai Zhang
## 2020/10/31
...
library(sjPlot)
library(sjmisc)
tab_model(modelt,CSS = list(css.centeralign='text-align: center;'))
tab_model(modelb,CSS = list(css.centeralign='text-align: center;'))
```
...
```{r prediction by state with NA citizen, warning=FALSE, echo=FALSE, message=FALSE}
...
```{r prediction by state without NA citizen, warning=FALSE, echo=FALSE, message=FALSE}
...
```{r Support rate, message=FALSE,echo=FALSE}
...
```{r tester, warning=FALSE, echo=FALSE, message=FALSE}
# library(tableHTML)
